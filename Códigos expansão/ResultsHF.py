...
file = "C:/Users/Bruno/Desktop/IC-2021/Python/Results1MTJHF.txt"
f = open(file, "w")
...
for i in range( 1, ElementosMatriz + 1):
    if i == int((ElementosMatriz/16)*7):
        print("real chargeIRd" + str(i) + " = avg(integ(sig=I(Vtest" + str(i) + "), from=1.65n, to=1.95n ))", file=open(file, "a"))
...
for i in range( 1, ElementosMatriz + 1):
    if i == int((ElementosMatriz/16)*7):
        print("real chargeIWr" + str(i) + " = avg(integ(sig=I(Vtest" + str(i) + "), from=2.54n, to=2.84n ))", file=open(file, "a"))
...
for i in range( 1, ElementosMatriz + 1):
    if i != int((ElementosMatriz/16)*7):
        print("real chargeIWrt" + str(i) + " = avg(integ(sig=I(Vtest" + str(i) + "), from=2.54n, to=2.84n ))", file=open(file, "a"))
...
for i in range( 1, ElementosMatriz + 1):
    if i == int((ElementosMatriz/16)*7):
        print("export real CurBL = abs(I(Vtest" + str(i) + ")@1.7n)\n\n", end = '', file=open(file, "a"))

print("export real TpRd = 1.7n-TpRead\n}\n", file=open(file, "a"))


print("search TpRead from binary(start=1.5n, stop=1.71n, tol=1f){\nrun TmpRead\n}while (TmpRead->CurBL > 0.00083)\n", file=open(file, "a"))
...
for i in range( 1, ElementosMatriz + 1):
    if i == int((ElementosMatriz/16)*7):
        print("export real CurX = abs(I(Vtest" + str(i) + ")@2.7n)\n\n", end = '', file=open(file, "a"))

print("export real TpWrt = 2.7n - TpWrite\n}\n", file=open(file, "a"))


print("search TpWrite from binary(start=2.4n, stop=2.6999999n, tol=1f){\nrun TmpWrite\n}while (TmpWrite->CurX > 0.0045 && TmpWrite->CurX < 0.00465)\n", file=open(file, "a"))
